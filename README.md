...
- المستودع: خاص.
- المرحلة **S1 مكتملة ومعتمدة ومدمجة** عبر PR #11، مع إصلاح سلامة المرجع قيد المراجعة.
- المرحلة **S2 متوقفة مؤقتًا** حتى دمج إصلاح المرجع ونجاح فحص ما بعد الدمج.
- المرجع الحاكم الوحيد: ملف Word المعتمد الذي يُعاد بناؤه محليًا في `docs/APPROVED_REQUIREMENTS.docx`.
- تُحفظ بايتاته دون تعديل كمقاطع Base64 مرتبة ومحددة صراحة في `FOUNDATION_MANIFEST.json`؛ الأجزاء القديمة 05 إلى 07 غير حاكمة بعد اكتشاف تلفها.
