...
CREATE TABLE IF NOT EXISTS works (
  ...
  university TEXT,
  status TEXT NOT NULL DEFAULT 'NEW_REQUEST' CHECK (status IN ('NEW_REQUEST','REQUIREMENT_REVIEW','NEEDS_PRICING','WAITING_CLIENT_RESPONSE','NEEDS_FOLLOW_UP','AGREED','IN_PROGRESS','WAITING_CUSTOMER_INFO','WAITING_REVIEW','REVISION_REQUIRED','PAUSED','CANCELLED_BEFORE_EXECUTION','PARTIALLY_STOPPED','COMPLETED','DELIVERED','ARCHIVED')),
  description TEXT,
