...
- إقفال S2 الإداري: PR #18؛ يغلق Issue #1 عند دمجه
- حالة S2: **مكتملة ومعتمدة ومدمجة، وتصبح مقفلة إداريًا بدمج PR #18**
...
- حالة S3: **لم تبدأ، ولا يجوز بدء تنفيذها من PR #18**
...
بعد دمج PR #18 وإغلاق Issue #1، يبقى S3 غير مبدوءة حتى إصدار توجيه مستقل لبدء Issue #2 على فرع وPR خاصين بها.